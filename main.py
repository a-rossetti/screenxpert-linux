...
class WindowArrangementUI(QWidget):
    ...
    def move_and_resize_window(self, width, height, x, y, tile_vertically=False, tile_horizontally=False):
    ...
    def show_main_display_options(self):
        ...
        self.add_button('Full\n Screen', 20, 20, 288, 162, lambda: self.move_and_resize_window(3840, 2160, 0, 0, True, True))
        self.add_button('Left\n half', 328, 20, 144, 162, lambda: self.move_and_resize_window(1920, 2160, 0, 0, True))
        self.add_button('Right\n half', 472, 20, 144, 162, lambda: self.move_and_resize_window(1920, 2160, 1920, 0, True))
        self.add_button('Two\n thirds', 20, 202, 192, 162, lambda: self.move_and_resize_window(2560, 2160, 0, 0))
        self.add_button('One\n third', 212, 202, 96, 162, lambda: self.move_and_resize_window(1280, 2160, 2560, 0))
        self.add_button('Top\n left', 328, 202, 144, 81, lambda: self.move_and_resize_window(1920, 1080, 0, 0))
        self.add_button('Top\n right', 472, 202, 144, 81, lambda: self.move_and_resize_window(1920, 1080, 1920, 0))
        self.add_button('Bottom\n left', 328, 283, 144, 81, lambda: self.move_and_resize_window(1920, 1080, 0, 1080))
    ...
    def show_screenpad_plus_options(self):
        ...
        self.add_button('Full\n Screen', 20, 20, 384, 110, lambda: self.move_and_resize_window(3840, 1100, 0, 2160, True, True))
        self.add_button('Left\n half', 20, 150, 192, 110, lambda: self.move_and_resize_window(1920, 1100, 0, 2160, True))
        self.add_button('Right\n half', 212, 150, 192, 110, lambda: self.move_and_resize_window(1920, 1100, 1920, 2160, True))
